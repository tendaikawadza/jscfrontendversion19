...
export class CustomerService {
    ...
    public updatepurchaserequest(FormData: any,id:any): Observable<HttpErrorResponse> {
        return this.http.post<any>(`${environment.apiUrl}/purchase-requisition/${id}`,FormData);  
